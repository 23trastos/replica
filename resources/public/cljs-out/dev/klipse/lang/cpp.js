...
try{var config = cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"stdio","stdio",-1570777132),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"write","write",-1857649168),(function (p1__26809_SHARP_){
return cljs.core.async.put_BANG_.call(null,c,p1__26809_SHARP_);
})], null)], null));
var input = "";
var exitCode = (function (){var obj__18568__auto__ = JSCPP;
var f__18569__auto__ = (function (){var obj26811 = obj__18568__auto__;
var k26812 = "run";
if(applied_science.js_interop.impl.contains_QMARK__STAR_.call(null,obj26811,k26812)){
return (obj26811[k26812]);
} else {
return null;
}
})();
return f__18569__auto__.call(obj__18568__auto__,s,input,config);
})();
...
var vec__26813 = klipse.lang.cpp.eval_in_chan.call(null,s,c);
var status = cljs.core.nth.call(null,vec__26813,(0),null);
var res = cljs.core.nth.call(null,vec__26813,(1),null);
var G__26816_26817 = status;
var G__26816_26818__$1 = (((G__26816_26817 instanceof cljs.core.Keyword))?G__26816_26817.fqn:null);
switch (G__26816_26818__$1) {
case "ok":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26816_26818__$1)].join('')));
