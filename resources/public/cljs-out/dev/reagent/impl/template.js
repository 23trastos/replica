...
var G__34659 = o;
(G__34659[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__34663 = o;
(G__34663[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__34665__i < G__34665__a.length) {G__34665__a[G__34665__i] = arguments[G__34665__i + 0]; ++G__34665__i;}
  args = new cljs.core.IndexedSeq(G__34665__a,0,null);
} 
...
var args = cljs.core.seq(arglist__34666);
...
var G__34668 = props;
var G__34668__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__34668,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34668);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__34668__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__34669){
...
var props = map__34670__$1;
var class$ = cljs.core.get.call(null,map__34670__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__34670,map__34670__$1,props,class$){
return (function (c){
...
});})(map__34670,map__34670__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__34672){
...
var on_write = cljs.core.get.call(null,map__34673__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__34673,map__34673__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__34673,map__34673__$1,on_write))
);
} else {
...
var G__34676 = jsprops;
(G__34676["defaultValue"] = value);

(G__34676["onChange"] = ((function (G__34676,v,value,on_change){
return (function (p1__34675_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__34675_SHARP_);
});})(G__34676,v,value,on_change))
);
...
var vec__34679 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__34679,(0),null);
var id = cljs.core.nth.call(null,vec__34679,(1),null);
var class$ = cljs.core.nth.call(null,vec__34679,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___34683 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___34683 == null)){
} else {
var key_34684 = temp__5724__auto___34683;
(jsprops["key"] = key_34684);
}
...
var temp__5724__auto___34685 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___34685 == null)){
} else {
var key_34686 = temp__5724__auto___34685;
reagent.impl.template.oset.call(null,jsprops,"key",key_34686);
}
...
var G__34687 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__34687["name"] = c);
...
var len__4730__auto___34693 = arguments.length;
var i__4731__auto___34694 = (0);
while(true){
if((i__4731__auto___34694 < len__4730__auto___34693)){
args__4736__auto__.push((arguments[i__4731__auto___34694]));

var G__34695 = (i__4731__auto___34694 + (1));
i__4731__auto___34694 = G__34695;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq34691){
var G__34692 = cljs.core.first.call(null,seq34691);
var seq34691__$1 = cljs.core.next.call(null,seq34691);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34692,seq34691__$1);
});
...
break;
default:
var G__34698 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__34698;
continue;
...
var n__4607__auto___34700 = a.length;
var i_34701 = (0);
while(true){
if((i_34701 < n__4607__auto___34700)){
(a[i_34701] = reagent.impl.template.as_element.call(null,(a[i_34701])));

var G__34702 = (i_34701 + (1));
i_34701 = G__34702;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___34703 = a.length;
var i_34704 = (0);
while(true){
if((i_34704 < n__4607__auto___34703)){
var val_34705 = (a[i_34704]);
if(((cljs.core.vector_QMARK_.call(null,val_34705)) && ((reagent.impl.template.key_from_vec.call(null,val_34705) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_34704] = reagent.impl.template.as_element.call(null,val_34705));

var G__34706 = (i_34704 + (1));
i_34704 = G__34706;
continue;
} else {
}
...
var ctx = ({});
var vec__34707 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__34707,(0),null);
var derefed = cljs.core.nth.call(null,vec__34707,(1),null);
...
var G__34710 = (cljs.core.count.call(null,argv) - first_child);
switch (G__34710) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__34710){
