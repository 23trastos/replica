...
var G__23144 = o;
(G__23144[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__23148 = o;
(G__23148[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__23149__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__23150__i < G__23150__a.length) {G__23150__a[G__23150__i] = arguments[G__23150__i + 0]; ++G__23150__i;}
  args = new cljs.core.IndexedSeq(G__23150__a,0,null);
} 
return G__23149__delegate.call(this,args);};
...
return G__23149__delegate(args);
});
...
var G__23153 = props;
var G__23153__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__23153,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23153);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__23153__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__23154){
var map__23155 = p__23154;
var map__23155__$1 = (((((!((map__23155 == null))))?(((((map__23155.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23155.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23155):map__23155);
var props = map__23155__$1;
var class$ = cljs.core.get.call(null,map__23155__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__23155,map__23155__$1,props,class$){
return (function (c){
...
});})(map__23155,map__23155__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__23157){
...
var on_write = cljs.core.get.call(null,map__23158__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__23158,map__23158__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__23158,map__23158__$1,on_write))
);
} else {
...
var jsprops = ({"argv": v});
var temp__5724__auto___23168 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___23168 == null)){
} else {
var key_23169 = temp__5724__auto___23168;
...
var temp__5724__auto___23170 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___23170 == null)){
} else {
var key_23171 = temp__5724__auto___23170;
reagent.impl.template.oset.call(null,jsprops,"key",key_23171);
}
...
var G__23172 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__23172["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23176){
var G__23177 = cljs.core.first.call(null,seq23176);
var seq23176__$1 = cljs.core.next.call(null,seq23176);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23177,seq23176__$1);
});
...
break;
default:
var G__23183 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__23183;
continue;
...
var n__4607__auto___23185 = a.length;
var i_23186 = (0);
while(true){
if((i_23186 < n__4607__auto___23185)){
(a[i_23186] = reagent.impl.template.as_element.call(null,(a[i_23186])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___23188 = a.length;
var i_23189 = (0);
while(true){
if((i_23189 < n__4607__auto___23188)){
var val_23190 = (a[i_23189]);
if(((cljs.core.vector_QMARK_.call(null,val_23190)) && ((reagent.impl.template.key_from_vec.call(null,val_23190) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_23189] = reagent.impl.template.as_element.call(null,val_23190));

var G__23191 = (i_23189 + (1));
i_23189 = G__23191;
continue;
} else {
}
...
var ctx = ({});
var vec__23192 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23192,(0),null);
var derefed = cljs.core.nth.call(null,vec__23192,(1),null);
...
var G__23195 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23195) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__23195){
