...
var digit_10332 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_10333__$1 = (vlq >>> (5));
while(true){
if((vlq_10333__$1 > (0))){
var digit_10334__$1 = (digit_10332 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_10334__$1));

var G__10335 = (vlq_10333__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__10336 = (vlq_10333__$1 >>> (5));
digit_10332 = G__10335;
vlq_10333__$1 = G__10336;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_10332));
}
break;
}
...
var G__10337 = i__$1;
var G__10338 = result__$1;
var G__10339 = shift__$1;
i = G__10337;
result = G__10338;
shift = G__10339;
continue;
