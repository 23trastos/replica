...
var G__27962 = devtools.prefs.pref.call(null,v);
v = G__27962;
continue;
} else {
return v;
...
}catch (e27965){var _e__26974__auto__ = e27965;
return false;
}})();
...
}catch (e27969){var _e__26974__auto__ = e27969;
return false;
}})();
...
}catch (e27971){var _e__26974__auto__ = e27971;
return false;
}}
}
});
...
var vec__27973 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27973,(0),null);
var name = cljs.core.nth.call(null,vec__27973,(1),null);
...
return cljs.core.some.call(null,(function (p1__27976_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27976_SHARP_);
}),template);
});
