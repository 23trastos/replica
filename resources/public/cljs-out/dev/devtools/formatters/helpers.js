...
var G__43280 = devtools.prefs.pref.call(null,v);
v = G__43280;
continue;
} else {
return v;
...
}catch (e43283){var _e__42091__auto__ = e43283;
return false;
}})();
...
}catch (e43287){var _e__42091__auto__ = e43287;
return false;
}})();
...
}catch (e43289){var _e__42091__auto__ = e43289;
return false;
}}
}
});
...
var vec__43291 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__43291,(0),null);
var name = cljs.core.nth.call(null,vec__43291,(1),null);
...
return cljs.core.some.call(null,(function (p1__43294_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43294_SHARP_);
}),template);
});
