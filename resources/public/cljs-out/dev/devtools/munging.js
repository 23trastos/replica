...
var o27857 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27857["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27858 = temp__5718__auto____$1;
return (o27858["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26967__auto__ = f;
return (o__26967__auto__["toString"]).call(o__26967__auto__);
} else {
return "";
}
...
try{var o__26967__auto___27861 = t;
(o__26967__auto___27861["cljs$lang$ctorPrWriter"]).call(o__26967__auto___27861,t,writer);
}catch (e27860){var __27862 = e27860;
}
...
var char_code = (function (){var o__26967__auto__ = (new String(char$));
return (o__26967__auto__["charCodeAt"]).call(o__26967__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26967__auto__ = String;
return (o__26967__auto__["fromCharCode"]).call(o__26967__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27863 = num_code;
switch (G__27863) {
case (1):
return (185);
...
var o__26967__auto__ = String;
return (o__26967__auto__["fromCharCode"]).call(o__26967__auto__,superscript_code);
});
/**
...
}catch (e27865){var _e__26974__auto__ = e27865;
return false;
}})())){
...
var vec__27866 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27866,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27869 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27869["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27870 = temp__5718__auto____$1;
return (o27870["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27873){
var vec__27874 = p__27873;
var ns_detector = cljs.core.nth.call(null,vec__27874,(0),null);
...
var G__27880 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27881 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27880;
remaining_tokens = G__27881;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27871){
var G__27872 = cljs.core.first.call(null,seq27871);
var seq27871__$1 = cljs.core.next.call(null,seq27871);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27872,seq27871__$1);
});
...
var vec__27885 = cljs.core.split_with.call(null,(function (p1__27884_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27884_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27885,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27885,(1),null);
...
var vec__27891 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27891,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27891,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27894 = cljs.core.rest.call(null,remaining_tokens);
var G__27895 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27894;
name_tokens = G__27895;
continue;
} else {
...
var vec__27898 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27898,(0),null);
var arity = cljs.core.nth.call(null,vec__27898,(1),null);
var vec__27901 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27901,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27901,(1),null);
var vec__27904 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27904,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27904,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27904,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27904,(3),null);
...
var vec__27910 = result;
var munged_ns = cljs.core.nth.call(null,vec__27910,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27910,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27910,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27910,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27910,(4),null);
var arity = cljs.core.nth.call(null,vec__27910,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27914 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27914,(0),null);
var args = cljs.core.nth.call(null,vec__27914,(1),null);
var vec__27917 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27917,(0),null);
var name = cljs.core.nth.call(null,vec__27917,(1),null);
...
var G__27920 = (arity + (1));
var G__27921 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27922){
var vec__27923 = p__27922;
var arity = cljs.core.nth.call(null,vec__27923,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27923,(1),null);
...
return cljs.core.get.call(null,arities,p1__27926_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27927_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27930){
var vec__27931 = p__27930;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27931,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27928){
var G__27929 = cljs.core.first.call(null,seq27928);
var seq27928__$1 = cljs.core.next.call(null,seq27928);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27929,seq27928__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27939__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27939__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27939__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27939__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27940 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27940,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27940,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27940,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27940,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27940,(4),null);
var arity = cljs.core.nth.call(null,vec__27940,(5),null);
...
var o__26967__auto__ = f;
return (o__26967__auto__["getBasis"]).call(o__26967__auto__);
});
/**
...
}catch (e27944){var _e__26974__auto__ = e27944;
...
var G__27945 = (obj[cljs.core.first.call(null,path)]);
var G__27946 = cljs.core.rest.call(null,path);
obj = G__27945;
path = G__27946;
continue;
} else {
...
return (function (accum,p__27947){
var vec__27948 = p__27947;
var bit = cljs.core.nth.call(null,vec__27948,(0),null);
var protocol = cljs.core.nth.call(null,vec__27948,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27951){
var vec__27952 = p__27951;
var ns = cljs.core.nth.call(null,vec__27952,(0),null);
var name = cljs.core.nth.call(null,vec__27952,(1),null);
var selector = cljs.core.nth.call(null,vec__27952,(2),null);
...
return (function (p__27956){
var vec__27957 = p__27956;
var munged_name = cljs.core.nth.call(null,vec__27957,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27957,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27957,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27955_SHARP_){
return (obj[cljs.core.first.call(null,p1__27955_SHARP_)]);
});})(name,sorted_matches,vec__27957,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
