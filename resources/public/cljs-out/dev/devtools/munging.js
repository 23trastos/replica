...
var o43157 = temp__5718__auto__;
var temp__5718__auto____$1 = (o43157["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o43158 = temp__5718__auto____$1;
return (o43158["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42084__auto__ = f;
return (o__42084__auto__["toString"]).call(o__42084__auto__);
} else {
return "";
}
}catch (e43159){var _ = e43159;
return "";
}});
...
try{var o__42084__auto___43161 = t;
(o__42084__auto___43161["cljs$lang$ctorPrWriter"]).call(o__42084__auto___43161,t,writer);
}catch (e43160){var __43162 = e43160;
}
...
var char_code = (function (){var o__42084__auto__ = (new String(char$));
return (o__42084__auto__["charCodeAt"]).call(o__42084__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42084__auto__ = String;
return (o__42084__auto__["fromCharCode"]).call(o__42084__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43163 = num_code;
switch (G__43163) {
case (1):
return (185);
...
var o__42084__auto__ = String;
return (o__42084__auto__["fromCharCode"]).call(o__42084__auto__,superscript_code);
});
/**
...
}catch (e43165){var _e__42091__auto__ = e43165;
return false;
}})())){
...
var vec__43166 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43166,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o43169 = temp__5718__auto__;
var temp__5718__auto____$1 = (o43169["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o43170 = temp__5718__auto____$1;
return (o43170["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___43177 = arguments.length;
var i__4731__auto___43178 = (0);
while(true){
if((i__4731__auto___43178 < len__4730__auto___43177)){
args__4736__auto__.push((arguments[i__4731__auto___43178]));

var G__43179 = (i__4731__auto___43178 + (1));
i__4731__auto___43178 = G__43179;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43173){
var vec__43174 = p__43173;
var ns_detector = cljs.core.nth.call(null,vec__43174,(0),null);
...
var G__43180 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43181 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43180;
remaining_tokens = G__43181;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43171){
var G__43172 = cljs.core.first.call(null,seq43171);
var seq43171__$1 = cljs.core.next.call(null,seq43171);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43172,seq43171__$1);
});
...
var vec__43185 = cljs.core.split_with.call(null,(function (p1__43184_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43184_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43185,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43185,(1),null);
...
var vec__43191 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43191,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43191,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43194 = cljs.core.rest.call(null,remaining_tokens);
var G__43195 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43194;
name_tokens = G__43195;
continue;
} else {
...
var vec__43198 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43198,(0),null);
var arity = cljs.core.nth.call(null,vec__43198,(1),null);
var vec__43201 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43201,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43201,(1),null);
var vec__43204 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43204,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43204,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43204,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43204,(3),null);
...
var vec__43210 = result;
var munged_ns = cljs.core.nth.call(null,vec__43210,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43210,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43210,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43210,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43210,(4),null);
var arity = cljs.core.nth.call(null,vec__43210,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__43214 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__43214,(0),null);
var args = cljs.core.nth.call(null,vec__43214,(1),null);
var vec__43217 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43217,(0),null);
var name = cljs.core.nth.call(null,vec__43217,(1),null);
...
var G__43220 = (arity + (1));
var G__43221 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43222){
var vec__43223 = p__43222;
var arity = cljs.core.nth.call(null,vec__43223,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43223,(1),null);
...
return cljs.core.get.call(null,arities,p1__43226_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__43227_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43230){
var vec__43231 = p__43230;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43231,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43228){
var G__43229 = cljs.core.first.call(null,seq43228);
var seq43228__$1 = cljs.core.next.call(null,seq43228);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43229,seq43228__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__43239__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43239__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43239__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43239__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43240 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43240,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43240,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43240,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43240,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43240,(4),null);
var arity = cljs.core.nth.call(null,vec__43240,(5),null);
...
var o__42084__auto__ = f;
return (o__42084__auto__["getBasis"]).call(o__42084__auto__);
});
/**
...
}catch (e43244){var _e__42091__auto__ = e43244;
...
var G__43245 = (obj[cljs.core.first.call(null,path)]);
var G__43246 = cljs.core.rest.call(null,path);
obj = G__43245;
path = G__43246;
continue;
} else {
...
return (function (accum,p__43247){
var vec__43248 = p__43247;
var bit = cljs.core.nth.call(null,vec__43248,(0),null);
var protocol = cljs.core.nth.call(null,vec__43248,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43251){
var vec__43252 = p__43251;
var ns = cljs.core.nth.call(null,vec__43252,(0),null);
var name = cljs.core.nth.call(null,vec__43252,(1),null);
var selector = cljs.core.nth.call(null,vec__43252,(2),null);
...
return (function (p__43256){
var vec__43257 = p__43256;
var munged_name = cljs.core.nth.call(null,vec__43257,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43257,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__43257,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__43255_SHARP_){
return (obj[cljs.core.first.call(null,p1__43255_SHARP_)]);
});})(name,sorted_matches,vec__43257,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
